...
export function DeckPublisher({ onClose, onPublish, isDarkMode = true }: DeckPublisherProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-hidden sm:overflow-y-auto animated fadeIn">
      <div className={cn(
        "w-full max-w-lg p-6 pb-28 sm:pb-6 rounded-t-3xl sm:rounded-lg shadow-md relative transition-all duration-300 max-h-[90dvh] sm:max-h-none overflow-y-auto",
