...
import { Terminal, Lock, User as UserIcon, AtSign, AlignLeft, Image as ImageIcon, ArrowRight, ArrowLeft } from "lucide-react";
              ...
              {signupStep === 1 && (
                <div className="space-y-4 animate-in fade-in duration-300">
                  ...
                  <div className="pt-4 mt-6 border-t border-outline-variant/30 flex justify-between items-center">
                    <span className="font-mono text-[10px] text-on-surface-variant uppercase tracking-wider">Step 1 of 2</span>
                    <Button 
                      type="button" 
                      onClick={nextStep}
                      variant="primary"
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-primary-container border border-outline-variant rounded-sm px-3 py-2 text-sm focus:outline-none focus:border-on-surface transition-colors text-center font-mono placeholder:text-on-surface-variant/50 min-h-[60px]"
                      placeholder="Engineer, Maker, Student"
                    />
                  </div>
